...
const instruments = {
  ...
  // UNIVERSAL SCREENING (everyone gets this first)
  PHQ9: [
    ...
    { id:'PHQ8', text:'Moving or speaking slowly, or being fidgety/restless', scale:4 },
  ...
  // PERSONALITY (everyone gets this)
  BIG5: [
  ...
  // CONDITIONAL — triggered by PHQ > 10
  DEPRESSION_DEEP: [
  ...
  // CONDITIONAL — triggered by GAD > 10
  ANXIETY_DEEP: [
  ...
  // CONDITIONAL — triggered by DD3 (mood swings)
  BIPOLAR_MDQ: [
  ...
  // CONDITIONAL — triggered by AD3 (repetitive thoughts)
  OCD_OCIR: [
  ...
  // CONDITIONAL — triggered by AD4 (trauma)
  PTSD_PCL5: [
  ...
  // CONDITIONAL — triggered if age < 30 and attention issues
  ADHD_ASRS: [
  ...
  // CONDITIONAL — triggered by work-related answers
  BURNOUT: [
  ...
  // SLEEP (triggered by PHQ3 or GAD scores)
  SLEEP_PSQI: [
  ...
  // SELF ESTEEM — RSE (everyone gets this)
  RSE: [
...
function buildQuestionFlow(answers) {
  const phqScore = ['PHQ1','PHQ2','PHQ3','PHQ4','PHQ5',
                    'PHQ6','PHQ7','PHQ8','PHQ9']
...
export default function AdaptiveQuestionnaire({ onComplete }) {
  ...
  const handleAnswer = (val) => {
    ...
    if (isLastQInSection) {
      // Recalculate flow with updated answers
    ...
    <div style={{ fontFamily:'sans-serif', maxWidth:580, margin:'0 auto' }}>
      <div style={{ background:'#fff', borderRadius:20, padding:36,
        ...
        <p style={{ color:'#64748b', fontSize:14, marginBottom:28 }}>
          This adaptive assessment adjusts based on your responses — just like a real psychologist would. Takes 10-20 minutes.
        </p>
        ...
        <textarea placeholder="Briefly describe what you're experiencing or what you'd like to understand better..."
