...
// ── Icons ──────────────────────────────────────────────
const Icons = {
  overview: c => <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="7" height="7" rx="1.5" stroke={c} strokeWidth="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5" stroke={c} strokeWidth="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5" stroke={c} strokeWidth="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5" stroke={c} strokeWidth="1.5"/></svg>,
  ...
  journal: c => <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M4 19.5A2.5 2.5 0 016.5 17H20" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  ...
  appointments: c => <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="4" width="18" height="18" rx="2" stroke={c} strokeWidth="1.5"/><path d="M16 2v4M8 2v4M3 10h18" stroke={c} strokeWidth="1.5" strokeLinecap="round"/></svg>,
  insights: c => <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2a7 7 0 017 7c0 3.87-3.13 7-7 7s-7-3.13-7-7a7 7 0 017-7z" stroke={c} strokeWidth="1.5"/><path d="M12 16v6M8 22h8" stroke={c} strokeWidth="1.5" strokeLinecap="round"/></svg>,
...
export default function Dashboard({ user, profile, onStartAssessment, onLogout, onPsychologistMode, onACTEngine, onCrisis }) {
  ...
  const achievements = [
    { icon: '🔥', label: '7 Day Streak', earned: streakDays >= 7 },
    { icon: '📓', label: 'Journal Master', earned: journals.length >= 5 },
    { icon: '✅', label: 'Assessment Pro', earned: sessions.length >= 3 },
    { icon: '🧘', label: 'Mindful', earned: sessions.length >= 1 },
    { icon: '💪', label: 'Consistent', earned: sessions.length >= 5 },
  ];
